...
import LatencyPercentileDataRow from "./Metrics/LatencyPercentileDataRow";
import {minutes} from "../../util/Duration";

export default class PipelineDataContainer extends React.Component {
	...
	render() {
		return(
			<Tabs>
				...
				<Tab eventKey={2} title="Throughput">
					<Col lg={12}>
						<Col md={16}>
							<h5 className="text-center">Throughput: Last 5 Minutes</h5>
						</Col>
						<LineChart
