...
screen -S $SCREEN_SESSION_NAME -p 0 -X stuff "apps/market-spread/market-spread -i 127.0.0.1:7001,127.0.0.1:7000 -o 127.0.0.1:5555 -m 127.0.0.1:5001 -c 127.0.0.1:6000 -d 127.0.0.1:6001 -f ../../demos/marketspread/initial-nbbo-fixish.msg -e $MESSAGES -n node-name
"
