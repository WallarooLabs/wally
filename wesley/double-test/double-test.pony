...
class DoubleSentParser is (SentParser[DoubleSentMessage val] & TextMessageFileParser)
...
class DoubleReceivedParser is (ReceivedParser[DoubleReceivedMessage val] & FallorMessageFileParser)
