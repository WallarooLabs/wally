      ...
      let application = recover val
        Application("Alphabet Popularity Contest")
          .new_pipeline[Votes val, LetterTotal val]("Alphabet Votes",
            BYOISourceConfig[Votes val].from_options(VotesDecoder,
              BYOISourceConfigCLIParser(env.args)?(0)?))
            ...
            .to_sink(BYOISinkConfig[LetterTotal val].from_options(
              LetterTotalEncoder,
              BYOISinkConfigCLIParser(env.args)?(0)?))
      end
