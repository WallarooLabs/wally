...
actor TCPSink is (CreditFlowConsumer & RunnableStep)
  ...
  embed _pending: List[(ByteSeq, USize, MsgEnvelope val)] = _pending.create()
  ...
  fun ref _unit_finished(number_finished: USize, last_sent: MsgEnvelope val) =>
    """
 ...
 be _event_notify(event: AsioEventID, flags: U32, arg: U32) =>
  ...
  fun ref _write_final(data: ByteSeq, tracking_info: MsgEnvelope val) =>
    """
  ...
  fun ref _pending_writes() =>
    ...
    """
    var final_pending_sent: (MsgEnvelope val | None) = None
