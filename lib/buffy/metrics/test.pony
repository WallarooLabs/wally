...
class iso _TestMonitoringHubEncoder is UnitTest
  ...
  fun apply(h: TestHelper) ? =>
    ...
    mc.process_report("1", StepMetricsReport(1000, 1999))
    mc.process_report("1", StepMetricsReport(2000, 2999))
    mc.process_report("1", StepMetricsReport(3000, 3999))
    mc.process_report("1", StepMetricsReport(4000, 4999))
    mc.process_report("1", StepMetricsReport(5000, 5999))

    mc.process_report("2", StepMetricsReport(1000, 1999))
    mc.process_report("2", StepMetricsReport(2000, 2999))
    mc.process_report("2", StepMetricsReport(3000, 3999))
    mc.process_report("2", StepMetricsReport(4000, 4999))
    mc.process_report("2", StepMetricsReport(5000, 5999))

    let sink = BoundaryTypes.source_sink()
    let egress = BoundaryTypes.ingress_egress()
    mc.process_sink("1", BoundaryMetricsReport(sink, 9143, 1000, 2999))
    mc.process_sink("1", BoundaryMetricsReport(sink, 9147, 1500, 3499))
    mc.process_sink("1", BoundaryMetricsReport(sink, 9196, 2500, 6000))
    mc.process_sink("1", BoundaryMetricsReport(sink, 9173, 2550, 5950))
    mc.process_boundary("1", BoundaryMetricsReport(egress, 9198, 2000, 4000))
