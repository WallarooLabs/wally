...
The complete example is available [here](https://github.com/Sendence/wallaroo/tree/master/examples/python/reverse/). To run it, follow the [Reverse application instructions](/examples/python/reverse/README.md)
