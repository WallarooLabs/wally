...
The complete alphabet example is available [here](https://github.com/Sendence/wallaroo/tree/release/examples/python/alphabet_partitioned/). To run it, follow the [Alphabet_partitioned application instructions](/examples/python/alphabet_partitioned/README.md)
