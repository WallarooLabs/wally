...
Now that we're setup, let's run our `reverse` example. You can find the instructions [here](https://github.com/WallarooLabs/wallaroo/tree/release-0.1.0-rc4/examples/python/reverse/README.md).
