...
The complete example is available [here](https://github.com/WallarooLabs/wallaroo/tree/release-0.1.2/examples/python/word_count/). To run it, follow the [Word Count application instructions](https://github.com/WallarooLabs/wallaroo/tree/release-0.1.2/examples/python/word_count/README.md)
