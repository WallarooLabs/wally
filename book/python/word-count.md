...
This section will take you through our [Wallaroo word count example](https://github.com/Sendence/wallaroo/tree/release/examples/python/word-count/). Along the way, we will introduce you to a couple of new concepts: parallelizing stateless computations, and splitting one incoming message into several outgoing ones.
