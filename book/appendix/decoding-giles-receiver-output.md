...
As the obvious next step is for a user to want to consume this data, we also provide [Fallor](https://github.com/WallarooLabs/wallaroo/tree/release-0.1.2/testing/tools/fallor) to decode this data.
