...
found in [`examples/alphabet/pony/alphabet.pony`](https://github.com/WallarooLabs/wallaroo-examples/tree/release-0.1.0-rc3/examples/alphabet/pony/alphabet.pony).
