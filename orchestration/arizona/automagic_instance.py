...
parser.add_argument("--no-spot", dest='spot', default=False, action="store_false" 
...
if cheapest_instance['InstanceType'] in pg_instances:
  ...
  pg_output = "ci_pg=is using placement groups#pg_arg=-var placement_group=arizona-$(cluster_name)#"
