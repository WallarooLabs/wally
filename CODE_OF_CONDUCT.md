...
Unlike the anti-harassment policy, violation of the social rules will not result in expulsion from the Wallaroo community or a strong warning from project maintainers. Rather, they are designed to provide some lightweight social structure for community members to use when interacting with each other.
